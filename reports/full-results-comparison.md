...
We filled the other missing Qwen3 evaluations at the original mixed-validation threshold: **2,000/2,000 AI detected and 41/2,000 human false positives (2.05%)** on the general EditLens test; **1,800/1,800 AI detected and 38/1,800 human false positives (2.11%)** on Enron; and **383/17,560 human false positives (2.18%)** on the ACL abstract audit. The ACL result is slightly above the 2% target and worse than the mixed-trained character (1.81%) and word (0.79%) baselines on that large human-only set.
